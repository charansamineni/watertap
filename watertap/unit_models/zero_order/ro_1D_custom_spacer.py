...
from watertap.core.spiral_wound_geometry_base import (
    ElementGeometry,
    _add_geometry_config,
)
...
class ReverseOsmosis1DCustomSpacerData(
    ...
    def calculate_scaling_factors(self):
        # TODO: Add additional scaling for the new cases
    ...
    # ==================================================================================================================
    # Adds the spacer relevant parameters to the report as a separate table
    def _get_performance_contents(self, time_point=0):
        ...
        spacer_dict = {"Channel Height": self.feed_side.channel_height,
                       "Spacer Porosity": self.feed_side.spacer_porosity}
