...
class CustomSpacer:
    ...
    def _add_variables(self):
        ...
        if self.config.spacer_type == SpacerType.net_spacer:
            ...
            self.feed_side.spacer_height = Param(
                initialize=1e-3,
                units=pyunits.m,
                within=PositiveReals,
                doc="spacer height",
        ...
        if self.config.sherwood_correlation == SherwoodCorrelation.da_costa:
            self.feed_side.Sh_corr_factor_da_costa = Param(
                initialize=1,
    ...
    def _add_no_spacer_constraints(self):
        ...
        # Create an immutable parameter for spacer porosity and delete the original Var
        del self.feed_side.spacer_porosity
        self.feed_side.spacer_porosity = Param(initialize=1, mutable=False)
